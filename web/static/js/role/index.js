...
var PageAction = {
  init: (props) => {
    ...
    const [currentRoleData, setCurrentRoleData] = React.useState({});
    PageState.currentRoleData = currentRoleData;
    PageState.setCurrentRoleData = setCurrentRoleData;
    ...
    const [waitChangeRoleDataId, setWaitChangeRoleDataId] = React.useState("");
    PageState.waitChangeRoleDataId = waitChangeRoleDataId;
    PageState.setWaitChangeRoleDataId = setWaitChangeRoleDataId;
  ...
  findTreeData: (v) => {
    ...
    axios.post(PageUrl.findTreeUrl, { roleName: v }).then((resp) => {
  ...
  findGridData: () => {
    ...
    let pageParams = {
      ...
      params: {
        roleParentCode: PageState.selectTreeNodeData?.roleCode,
        ...searchFormData
      }
    };
  ...
  addBrotherNode: (node) => {
    let roleParentCode = node.roleParentCode;
    let currentData = {
      roleParentCode
    };
    PageState.setCurrentRoleData(currentData);
    PageState.setAddFormDialogVisible(true);
  },
  addChildNode: (node) => {
    let roleParentCode = "#";
    if (node && node.roleCode) {
      roleParentCode = node.roleCode;
    } else {
      if (PageState.selectTreeNodeData && PageState.selectTreeNodeData.roleCode) {
        roleParentCode = PageState.selectTreeNodeData.roleCode;
      }
    }
    let currentData = {
  ...
  editNode: (node) => {
    ...
    axios.post(PageUrl.findInfoUrl + "?dataId=" + dataId, {}).then((resp) => {
      if (resp.code == 0) {
        PageState.setCurrentRoleData(resp.data);
  ...
  save(roleData, callback) {
    axios.post(PageUrl.saveUrl, roleData).then((resp) => {
      if (resp.code == 0) {
  ...
  updateParent(roleData, callback) {
    axios.post(PageUrl.updateParentUrl, roleData).then((resp) => {
      if (resp.code == 0) {
        arco.Message.success(resp.msg);
        callback();
      } else {
  ...
  changeParentNode: (node) => {
    PageState.setWaitChangeRoleDataId(node.dataId);
...
var RoleParentForm = () => {
  React.useEffect(() => {
    if (PageState.waitChangeRoleDataId && PageState.changeParentFormDialogVisible) {
...
// web/tsx/role/form/dialog.tsx
var AddRoleFormDialog = () => {
  ...
  }, /* @__PURE__ */ React.createElement(RoleForm, null));
};
var EditRoleFormDialog = () => {
...
var InfoRoleFormDialog = () => {
  ...
  }, /* @__PURE__ */ React.createElement(RoleInfoForm, null));
};
var ChangeParentRoleFormDialog = () => {
  return /* @__PURE__ */ React.createElement(arco.Modal, {
    title: "\u53D8\u66F4\u4E0A\u7EA7",
  ...
  }, /* @__PURE__ */ React.createElement(RoleParentForm, null));
};
var ImportRoleFormDialog = () => {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(arco.Modal, {
    title: "\u5BFC\u5165\u89D2\u8272",
...
var PageView = (props) => {
  ...
  }, /* @__PURE__ */ React.createElement(PageGridView, null))), /* @__PURE__ */ React.createElement(AddRoleFormDialog, null), /* @__PURE__ */ React.createElement(EditRoleFormDialog, null), /* @__PURE__ */ React.createElement(InfoRoleFormDialog, null), /* @__PURE__ */ React.createElement(ChangeParentRoleFormDialog, null), /* @__PURE__ */ React.createElement(ImportRoleFormDialog, null), /* @__PURE__ */ React.createElement(ExportRoleFormDialog, null));
};
var PageTreeView = () => {
