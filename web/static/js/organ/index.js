...
var PageAction = {
  ...
  findTreeData: (v) => {
    ...
    axios.post(PageUrl.findTreeUrl, { organName: v }).then((resp) => {
  ...
  addChildNode: (node) => {
    ...
    if (node && node.organCode) {
      ...
      if (PageState.selectTreeNodeData && PageState.selectTreeNodeData.organCode) {
        organParentCode = PageState.selectTreeNodeData.organCode;
      }
    }
    let currentData = {
  ...
  save(organData, callback) {
    axios.post(PageUrl.saveUrl, organData).then((resp) => {
      if (resp.code == 0) {
  ...
  updateParent(organData, callback) {
    axios.post(PageUrl.updateParentUrl, organData).then((resp) => {
      if (resp.code == 0) {
        arco.Message.success(resp.msg);
        callback();
      } else {
...
var OrganParentForm = () => {
  React.useEffect(() => {
    if (PageState.waitChangeOrganDataId && PageState.changeParentFormDialogVisible) {
...
// web/tsx/organ/form/dialog.tsx
var AddOrganFormDialog = () => {
  ...
  }, /* @__PURE__ */ React.createElement(OrganForm, null));
};
var EditOrganFormDialog = () => {
...
var InfoOrganFormDialog = () => {
  ...
  }, /* @__PURE__ */ React.createElement(OrganInfoForm, null));
};
var ChangeParentOrganFormDialog = () => {
  return /* @__PURE__ */ React.createElement(arco.Modal, {
    title: "\u53D8\u66F4\u4E0A\u7EA7",
  ...
  }, /* @__PURE__ */ React.createElement(OrganParentForm, null));
};
var ImportOrganFormDialog = () => {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(arco.Modal, {
    title: "\u5BFC\u5165\u7EC4\u7EC7",
...
var PageView = (props) => {
  ...
  }, /* @__PURE__ */ React.createElement(PageGridView, null))), /* @__PURE__ */ React.createElement(AddOrganFormDialog, null), /* @__PURE__ */ React.createElement(EditOrganFormDialog, null), /* @__PURE__ */ React.createElement(InfoOrganFormDialog, null), /* @__PURE__ */ React.createElement(ChangeParentOrganFormDialog, null), /* @__PURE__ */ React.createElement(ImportOrganFormDialog, null), /* @__PURE__ */ React.createElement(ExportOrganFormDialog, null));
};
var PageTreeView = () => {
