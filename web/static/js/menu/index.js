...
var PageAction = {
  ...
  findTreeData: (v) => {
    ...
    axios.post(PageUrl.findTreeUrl, { menuName: v }).then((resp) => {
  ...
  findGridData: () => {
    ...
    let pageParams = {
      ...
      params: {
        menuParentCode: PageState.selectTreeNodeData?.menuCode,
        ...searchFormData
      }
    };
  ...
  addBrotherNode: (node) => {
    let menuParentCode = node.menuParentCode;
    let currentData = {
      menuParentCode
    };
  ...
  addChildNode: (node) => {
    let menuParentCode = "#";
    if (node && node.menuCode) {
      menuParentCode = node.menuCode;
    } else {
      if (PageState.selectTreeNodeData && PageState.selectTreeNodeData.menuCode) {
        menuParentCode = PageState.selectTreeNodeData.menuCode;
      }
    }
    let currentData = {
  ...
  save(menuData, callback) {
    axios.post(PageUrl.saveUrl, menuData).then((resp) => {
      if (resp.code == 0) {
  ...
  updateParent(menuData, callback) {
    axios.post(PageUrl.updateParentUrl, menuData).then((resp) => {
      if (resp.code == 0) {
        arco.Message.success(resp.msg);
        callback();
      } else {
...
var MenuParentForm = () => {
  React.useEffect(() => {
    if (PageState.waitChangeMenuDataId && PageState.changeParentFormDialogVisible) {
...
// web/tsx/menu/form/dialog.tsx
var AddMenuFormDialog = () => {
  ...
  }, /* @__PURE__ */ React.createElement(MenuForm, null));
};
var EditMenuFormDialog = () => {
...
var InfoMenuFormDialog = () => {
  ...
  }, /* @__PURE__ */ React.createElement(MenuInfoForm, null));
};
var ChangeParentMenuFormDialog = () => {
  return /* @__PURE__ */ React.createElement(arco.Modal, {
    title: "\u53D8\u66F4\u4E0A\u7EA7",
  ...
  }, /* @__PURE__ */ React.createElement(MenuParentForm, null));
};
var ImportMenuFormDialog = () => {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(arco.Modal, {
    title: "\u5BFC\u5165\u7EC4\u7EC7",
...
var PageView = (props) => {
  ...
  }, /* @__PURE__ */ React.createElement(PageGridView, null))), /* @__PURE__ */ React.createElement(AddMenuFormDialog, null), /* @__PURE__ */ React.createElement(EditMenuFormDialog, null), /* @__PURE__ */ React.createElement(InfoMenuFormDialog, null), /* @__PURE__ */ React.createElement(ChangeParentMenuFormDialog, null), /* @__PURE__ */ React.createElement(ImportMenuFormDialog, null), /* @__PURE__ */ React.createElement(ExportMenuFormDialog, null));
};
var PageTreeView = () => {
