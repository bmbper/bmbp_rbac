...
export const PageAction = {
	...
	findTreeData: (v: String | null) => {
		...
		axios
			.post(PageUrl.findTreeUrl, { appGroupName: v })
			.then((resp: any) => {
	...
	batchRemoveNode: (dataIdList: String[]) => {
		axios
			.post(PageUrl.batchRemoveUrl, {
				dataIdList,
			})
			.then((resp: any) => {
				if (resp.code == 0) {
	...
	batchEnableNode: (dataIdList: string[]) => {
		axios
			.post(PageUrl.batchEnableUrl, {
				dataIdList,
			})
			.then((resp: any) => {
				if (resp.code == 0) {
	...
	batchDisableNode: (dataIdList: string[]) => {
		axios
			.post(PageUrl.batchDisableUrl, {
				dataIdList,
			})
			.then((resp: any) => {
				if (resp.code == 0) {
